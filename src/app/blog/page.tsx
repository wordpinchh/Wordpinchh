...
// ─── REAL BLOG DATA ────────────────────────────────────────────────────────────
// Each blog maps to the uploaded .md files exactly.
// category + tag assigned based on content topic.
// ──────────────────────────────────────────────────────────────────────────────
...
const BLOGS = [
  {
    ...
    content: [
      {
        type: "intro",
        text: "Your website probably isn't broken. It's just not clear enough. Many websites look polished on the surface — clean layout, good design, maybe even decent traffic — but still fail to generate leads. The problem almost always comes down to one thing: the message doesn't land.",
      },
      {
        type: "heading",
        text: "Why Your Website Isn't Converting",
      },
      {
        type: "text",
        text: "When a website fails to generate leads, most business owners assume the issue is traffic — they need more visitors. But traffic without clarity is just wasted attention. The real conversion killers are almost always messaging, structure, and trust.",
      },
      {
        type: "list",
        heading: "The core issues:",
        items: [
      ...
      {
        type: "heading",
        text: "Common Website Messaging Mistakes",
      },
      {
        type: "text",
        text: "Most low-converting websites share a handful of messaging patterns that quietly kill results. Leading with 'we' instead of 'you'. Features over outcomes. No emotional acknowledgement of where the reader is right now. Trying to speak to everyone — which means connecting with no one.",
      },
      {
        type: "heading",
        text: "How to Fix Low-Converting Pages",
      },
      {
        type: "text",
        text: "You don't need a full website overhaul. Start with your homepage headline — rewrite it to state clearly who you help, what you help them do, and the outcome they can expect. Audit your calls to action. Add proof near your CTAs. Rewrite from the reader's perspective.",
      },
      {
        type: "list",
        heading: "What high-converting pages include:",
        items: [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "Content marketing is the execution layer. It's the doing — creating articles, writing LinkedIn posts, producing videos, sending newsletters. It answers: What are we publishing? How often? Where? Content marketing is visible, schedulable, and measurable by volume. And because it's visible, it's the thing most founders jump into first.",
      },
      {
        type: "heading",
        text: "What Is Content Strategy?",
      },
      {
        type: "text",
        text: "Content strategy is the planning layer. It comes before execution and answers the deeper questions: Why are we creating content? Who is it actually for? What business goal does it serve? How does each piece connect to the next? Without it, everything you publish is disconnected — individual pieces that don't build toward anything.",
      },
      {
        type: "list",
      ...
      {
        type: "heading",
        text: "How to Build a Proper Content Strategy",
      },
      {
        type: "list",
        heading: "Five steps that actually work:",
        items: [
      ...
      {
        type: "closing",
        text: "If your content has felt like a lot of effort for very little return, the answer probably isn't to publish more. It's to take a step back and build the foundation that makes everything you publish work harder. Strategy first. Execution second. That's the order most founders get backwards — and the order that makes all the difference.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "intro",
        text: "Many blogs fail to rank not because of lack of effort, but because they miss what search engines are actually looking for. If you've been publishing regularly and your blog traffic is still flat, you're in good company — and the issues are almost always diagnosable.",
      },
      {
        type: "heading",
        text: "Common Blog SEO Mistakes",
      },
      {
        type: "list",
        heading: "The real culprits:",
        items: [
      ...
      {
        type: "heading",
        text: "How Google Evaluates Blog Content",
      },
      {
        type: "text",
      ...
      {
        type: "heading",
        text: "How to Fix Ranking Issues",
      },
      {
        type: "list",
        heading: "The actionable fixes:",
        items: [
      ...
      {
        type: "heading",
        text: "What High-Ranking Blogs Do Differently",
      },
      {
        type: "text",
  ...
  return (
    ...
    >
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(202,255,74,0.04) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "24px", flexWrap: "wrap" as const }}>
          ...
          <TagBadge tag={post.tag} color={post.tagColor} />
          <span style={{
            background: "#CAFF4A", color: "#0E0D0A",
            fontSize: "11px",
            fontFamily: "'DM Mono', monospace",
      ...
      <div style={{
        ...
        <div style={{
          ...
          width: "6px", height: "6px",
          borderRadius: "50%",
          background: hovered ? "#CAFF4A" : "#2a2720",
      ...
      <div className="min-h-screen bg-[#0E0D0A] text-[#F0EDE6] overflow-x-hidden" style={{ paddingTop: "16px" }} >
        ...
        {openPost ? (
          ...
          <>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {(() => {
                    ...
                    const items = [];
                    // Create 4 sets for smooth looping
                    for (let i = 0; i < 4; i++) {
                      cats.forEach((c, j) => {
                        items.push(
                          <span key={`${i}-${j}`} style={{
            ...
            {/* ── HERO ────────────────────────────────────────────── */}
            <div style={{ padding: "72px 60px 0", maxWidth: "1400px", margin: "0 auto" }}>
              {/* Page label */}
              <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "36px" }}>
                <div style={{ width: "32px", height: "1px", background: "floralwhite" }} />
                <span style={{
                  fontFamily: "'DM Mono', monospace",
                  ...
                  <div style={{ display: "flex", gap: "0", alignItems: "center" }}>
                    {[
                      ...
                      <div key={i} style={{ display: "flex", alignItems: "center" }}>
                        {i > 0 && <div style={{ width: "1px", height: "44px", background: "#2a2720", margin: "0 28px" }} />}
                        <div>
                          <div style={{
                            fontFamily: "'Bebas Neue', sans-serif",
                            fontSize: "clamp(2rem, 4vw, 3rem)",
                            color: stat.accent ? "#CAFF4A" : "#F0EDE6",
                            lineHeight: 1,
                          }}>{stat.value}</div>
                          <div style={{
                            fontFamily: "'DM Mono', monospace",
            ...
            {/* ── CATEGORY FILTER ─────────────────────────────────── */}
            <div style={{ padding: "32px 60px", maxWidth: "1400px", margin: "0 auto" }}>
            ...
            {/* ── BLOG CONTENT ────────────────────────────────────── */}
            <div style={{ padding: "0 60px 60px", maxWidth: "1400px", margin: "0 auto" }}>
